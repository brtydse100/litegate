...
| `admin` | Everything a user can do, plus manage local users, list installation keys, create keys for others through the API, and bulk-edit keys |
...
- creating, listing, disabling, and updating local users.
